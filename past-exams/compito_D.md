...
1. Determinare la circonferenza dei flessi dell'asta 5, nel suo moto rispetto al telaio.
...
3. In una coppia di ruote dentate interne con rapporto di trasmissione $\tau$ il rocchetto gira a $\omega$ rad/s. Quanto vale la velocità di strisciamento all'imbocco se è nota la lunghezza $P_0 M_1$? Giustificare il procedimento.

4. Riportare l'espressione del coefficiente di trasmissibilità e disegnare il grafico della funzione $C_{tr}(n)$ evidenziando l'influenza del fattore di smorzamento $\zeta$.
